            ...
            <div class="row">
                ...
                <div class="col-xl-10 col-lg-9 col-md-10 col-sm-12">
                    <div class="adm-forme container mx-2 ">
                        ...
                        <h1 class="mt-2 mb-3">Cadastrando anime (parte 3)</h1>
                        <div class="container">
                            <h2>Adicionar genero</h2>
                            <form class="d-flex col-6 " method="POST" action="<?= URL ?>/Animes/buscarGenero/<?= $dados['indicacao'] ?>/<?= $dados["id_anime"] ?>">
                        ...
                        <div class="container">
                            <?php if ($_SESSION['RESULTBUSC'] == 'not') : ?>
                                ...
                                if ($_SESSION['RESULTBUSC'] == 'yes') : ?>
                                    <div class="container">
                                        <form method="POST" name="adiconarGenero" action="<?= URL ?>/generos/AddGenSession/<?= $dados['indicacao'] ?>/<?= $dados["id_anime"] ?>">
                            ...
                            <div class="container">
                                ...
                                <form method="POST" name="retirarGenero" action="<?= URL ?>/generos/retirarGenSession/<?= $dados['indicacao'] ?>/<?= $dados["id_anime"] ?>">
                                    <div class="row">
                                        <?php
                        ...
                        <div class="row mt-4 ms-3 ">
                            ...
                            <div class="col"></div>
                            <div class="col "><a class="btn btn-outline-success" href="<?= URL ?>/Animes/PartFinal/<?= $dados['indicacao'] ?>/<?= $dados["id_anime"] ?>">Cadastrar</a></div>
